                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                        ...
                                        @else
                                            <div class="card-body">
                                                <form action="{{route('check.comment')}}" method="post">
                                                    ...
                                                    <button onclick="return confirm('Đăng nhập để sử dụng chức năng này?')" class="btn btn-primary">Bình luận</button>
                                                </form>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="media mb-4">
                                        <img class="d-flex mr-3 rounded-circle" style="width: 30px;height: 30px" src="{{asset('storage/images/'.$comment->user->image)}}" alt="">
